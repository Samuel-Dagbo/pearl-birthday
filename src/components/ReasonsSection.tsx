      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          {reasons.map((reason) => (
            ...
            >
              <div
                className={`absolute inset-0 bg-gradient-to-b ${reason.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
              />
              ...
              <div className="relative z-10">
                ...
                <p className="text-pink-200/50 text-sm sm:text-base leading-relaxed">
                  {reason.description}
                </p>
              </div>
